// Botanicare Project Specific JavaScript
  ...
  if (gradientText) {
    setInterval(() => {
      gradientText.style.textShadow = `
        0 0 5px rgba(100, 182, 138, 0.8),
        0 0 10px rgba(100, 182, 138, 0.6),
        0 0 15px rgba(100, 182, 138, 0.4),
        0 0 20px rgba(100, 182, 138, 0.2)
      `;

      setTimeout(() => {
        gradientText.style.textShadow = "0 0 30px rgba(100, 182, 138, 0.5)";
      }, 100);
    }, 2000);
  }
