// Secure It with Cyber Project Specific JavaScript

// Import particlesJS and bootstrap
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Add cyber glow effect to the title
  ...
  if (cyberText) {
    setInterval(() => {
      ...
      setTimeout(() => {
        cyberText.style.textShadow = "0 0 30px rgba(0, 212, 255, 0.5)";
      }, 100);
    }, 2000);
  }
});
